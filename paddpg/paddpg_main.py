...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', type=str, default='debug-result')
    ...
    parser.add_argument('--budget_para', nargs='+', default=[2])#[2, 4, 8, 16]
    ...
    parser.add_argument('--seed', type=int, default=100) # 10
